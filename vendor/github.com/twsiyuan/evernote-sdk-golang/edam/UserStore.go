...
type UserStore interface {  //Service:  UserStore
  ...
  // Parameters:
  //  - AuthenticationToken
  GetUser(authenticationToken string) (r *User, err error)
  ...
  // Parameters:
  //  - AuthenticationToken
  ListBusinessUsers(authenticationToken string) (r []*UserProfile, err error)
  ...
  ListBusinessInvitations(authenticationToken string, includeRequestedInvitations bool) (r []*BusinessInvitation, err error)
  ...
  // Parameters:
  //  - ServiceLevel
  GetAccountLimits(serviceLevel ServiceLevel) (r *AccountLimits, err error)
}
...
func (p *UserStoreClient) CheckVersion(clientName string, edamVersionMajor int16, edamVersionMinor int16) (r bool, err error) {
  if err = p.sendCheckVersion(clientName, edamVersionMajor, edamVersionMinor); err != nil { return }
...
func (p *UserStoreClient) GetBootstrapInfo(locale string) (r *BootstrapInfo, err error) {
  if err = p.sendGetBootstrapInfo(locale); err != nil { return }
...
func (p *UserStoreClient) AuthenticateLongSession(username string, password string, consumerKey string, consumerSecret string, deviceIdentifier string, deviceDescription string, supportsTwoFactor bool) (r *AuthenticationResult_, err error) {
  if err = p.sendAuthenticateLongSession(username, password, consumerKey, consumerSecret, deviceIdentifier, deviceDescription, supportsTwoFactor); err != nil { return }
...
func (p *UserStoreClient) CompleteTwoFactorAuthentication(authenticationToken string, oneTimeCode string, deviceIdentifier string, deviceDescription string) (r *AuthenticationResult_, err error) {
  if err = p.sendCompleteTwoFactorAuthentication(authenticationToken, oneTimeCode, deviceIdentifier, deviceDescription); err != nil { return }
...
func (p *UserStoreClient) RevokeLongSession(authenticationToken string) (err error) {
  if err = p.sendRevokeLongSession(authenticationToken); err != nil { return }
...
func (p *UserStoreClient) AuthenticateToBusiness(authenticationToken string) (r *AuthenticationResult_, err error) {
  if err = p.sendAuthenticateToBusiness(authenticationToken); err != nil { return }
...
// Parameters:
//  - AuthenticationToken
func (p *UserStoreClient) GetUser(authenticationToken string) (r *User, err error) {
  if err = p.sendGetUser(authenticationToken); err != nil { return }
...
func (p *UserStoreClient) recvGetUser() (value *User, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
...
func (p *UserStoreClient) GetPublicUserInfo(username string) (r *PublicUserInfo, err error) {
  if err = p.sendGetPublicUserInfo(username); err != nil { return }
...
func (p *UserStoreClient) GetUserUrls(authenticationToken string) (r *UserUrls, err error) {
  if err = p.sendGetUserUrls(authenticationToken); err != nil { return }
...
func (p *UserStoreClient) InviteToBusiness(authenticationToken string, emailAddress string) (err error) {
  if err = p.sendInviteToBusiness(authenticationToken, emailAddress); err != nil { return }
...
func (p *UserStoreClient) RemoveFromBusiness(authenticationToken string, emailAddress string) (err error) {
  if err = p.sendRemoveFromBusiness(authenticationToken, emailAddress); err != nil { return }
...
func (p *UserStoreClient) UpdateBusinessUserIdentifier(authenticationToken string, oldEmailAddress string, newEmailAddress string) (err error) {
  if err = p.sendUpdateBusinessUserIdentifier(authenticationToken, oldEmailAddress, newEmailAddress); err != nil { return }
...
// Parameters:
//  - AuthenticationToken
func (p *UserStoreClient) ListBusinessUsers(authenticationToken string) (r []*UserProfile, err error) {
  if err = p.sendListBusinessUsers(authenticationToken); err != nil { return }
...
func (p *UserStoreClient) recvListBusinessUsers() (value []*UserProfile, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
...
//  - AuthenticationToken
//  - IncludeRequestedInvitations
func (p *UserStoreClient) ListBusinessInvitations(authenticationToken string, includeRequestedInvitations bool) (r []*BusinessInvitation, err error) {
  if err = p.sendListBusinessInvitations(authenticationToken, includeRequestedInvitations); err != nil { return }
...
func (p *UserStoreClient) recvListBusinessInvitations() (value []*BusinessInvitation, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
...
// Parameters:
//  - ServiceLevel
func (p *UserStoreClient) GetAccountLimits(serviceLevel ServiceLevel) (r *AccountLimits, err error) {
  if err = p.sendGetAccountLimits(serviceLevel); err != nil { return }
  return p.recvGetAccountLimits()
}

func (p *UserStoreClient) sendGetAccountLimits(serviceLevel ServiceLevel)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *UserStoreClient) recvGetAccountLimits() (value *AccountLimits, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
